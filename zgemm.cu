...
fichier2=fopen("GFLOPS_ZGEMM.dat","w");/*
fichier3=fopen("/home/jfd/PROGRAMMES/Zgemm/zgemm_CUDA_s.dat","w");
fichier4=fopen("/home/jfd/PROGRAMMES/Zgemm/gflops_GPU.dat","w");*/
