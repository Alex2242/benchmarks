...
mkl_gemm_fp64_multithread:
	${CC} -fopenmp $(CFLAGS) -o ./bin/mkl_gemm_fp64_multithread.x ./src/zgemm_MKL2.c -I$(MKL_INC) -L${MKL_LIB}  $(MKL_OMP) $(LIB_STD)
...
mkl_gemm_fp32_monothread:
	${CC} -fopenmp $(CFLAGS) -o ./bin/mkl_gemm_fp32_multithread.x ./src/cgemm_MKL.c -I$(MKL_INC)  -L${MKL_LIB}  $(MKL_SEQ) $(LIB_STD)
